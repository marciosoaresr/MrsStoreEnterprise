...
namespace NSE.Identidade.API.Controllers
{
    ...
    public class AuthController : Controller
    {
        ...
        private async Task<UsuarioRespostaLogin> GerarJwt(string email)
        {
            ...
            claims.Add(new Claim(JwtRegisteredClaimNames.Nbf, ToUniEpochDate(DateTime.UtcNow).ToString()));
            claims.Add(new Claim(JwtRegisteredClaimNames.Iat, ToUniEpochDate(DateTime.UtcNow).ToString(), ClaimValueTypes.Integer64));
        ...
        private static long ToUniEpochDate(DateTime date)
